...
TableDataSource.prototype.loadText = function (text) {
    ...
    if (this.dataset && this.dataset.hasTimeData() && !defined(this.displayDuration)) {
        // rdengate DISPLAY DURATION
        var percentDisplay = 2.0;
...
TableDataSource.prototype._czmlRecFromPoint = function (point) {
    ...
    */
    ...
    {*/
        //rdengate (using individual billboards)
        rec.billboard = {
            horizontalOrigin : "CENTER",
            verticalOrigin : "BOTTOM",
            image : undefined,
            scale : scale,
            color : { "rgba" : [130, 0, 0, 250] },
...
TableDataSource.prototype.getCzmlDataPointList = function () {
    ...
    for (var i = 0; i < pointList.length; i++) {
        ...
        rec.billboard.image = pointList[i].billboard;
        var desc = this.describe(this.dataset.getDataRow(pointList[i].row));
        // It's the words field
        desc = desc.replace(new RegExp('<tr><td>Words<\/td><td align=\"right\">.+<\/td><\/tr>',"gm"), "");
        desc = desc.replace(new RegExp("<td>Primary image<\/td><td align=\"right\">(.*?)<\/td>"), "<img src=\"$1\">");
